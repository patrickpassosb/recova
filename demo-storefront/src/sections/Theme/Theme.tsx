 ...
 */
import SiteTheme, { Font } from "~/components/ui/Theme";
...
const snippets = {
  ...
  <button className="btn btn-sm btn-outline">Outline</button>
  ...
  {/* Second row */}
  <button className="btn btn-sm btn-outline">Button</button>
  <button className="btn btn-sm btn-primary btn-outline">Primary</button>
  <button className="btn btn-sm btn-secondary btn-outline">Secondary</button>
  <button className="btn btn-sm btn-accent btn-outline">Accent</button>

  {/* Third row */}
  <button className="btn btn-sm btn-ghost">Button</button>
  <button className="btn btn-sm btn-primary btn-ghost">Primary</button>
  <button className="btn btn-sm btn-secondary btn-ghost">Secondary</button>
  <button className="btn btn-sm btn-accent btn-ghost">Accent</button>

  {/* Fourth row */}
  <button className="btn btn-sm btn-link">Button</button>
  <button className="btn btn-sm btn-primary btn-link">Primary</button>
  <button className="btn btn-sm btn-secondary btn-link">Secondary</button>
  <button className="btn btn-sm btn-accent btn-link">Accent</button>`,
  buttonSizes: `
  {/* First row */}
  ...
  {/* Third row */}
  <button className="btn btn-lg btn-secondary">Large</button>
  <button className="btn btn-md btn-secondary">Normal</button>
  <button className="btn btn-sm btn-secondary">Small</button>
  <button className="btn btn-xs btn-secondary">Tiny</button>
  
  {/* Fourth row */}
  <button className="btn btn-lg btn-accent">Large</button>
  <button className="btn btn-md btn-accent">Normal</button>
  <button className="btn btn-sm btn-accent">Small</button>
